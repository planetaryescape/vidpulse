...
- Schedule focus periods (e.g., weekdays 9-5)
- Stricter thresholds during scheduled focus time
- Block entertainment during work hours
- Temporary pause when you need a break

## Political Content Analysis
- Detects political content in videos
- Maps your consumption on a 2D political compass
- Track how your media diet shifts over time
- Optional - disable if you prefer
...
## Channel Insights
- Track quality scores across channels
- See which channels you've liked videos from
- Identify your most valuable content sources
...
- Toggle: chapters, related content, political analysis
